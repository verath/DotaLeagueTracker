...
abstract class NetworkBoundResource<ResultType, RequestType : ResultResponse<*>>
@MainThread constructor(private val appExecutors: AppExecutors) {
    ...
    private fun fetchFromNetwork(dbSource: LiveData<ResultType>) {
        val apiResponse = callToLiveDataApiResponse(createCall())
    ...
    /**
     * Enqueues a Retrofit2.Call and returns an ApiResponse LiveData object representing
     * the result of the call.
     */
    private fun callToLiveDataApiResponse(call: Call<RequestType>): LiveData<ApiResponse<RequestType>> {
        val result = MutableLiveData<ApiResponse<RequestType>>()
        call.enqueue(ApiResponseCallback(result::postValue))
        return result
    }
